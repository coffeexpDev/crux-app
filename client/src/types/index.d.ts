...
): (arg0: QueryRecordOptions) => Promise<SuccessResponse | null>;
/** @param {CreateOptions} createOptions @return {function(QueryRecordOptions): Promise<HistoryResponse | null>} */
export function createQueryHistoryRecord(
  createOptions: CreateOptions
): (arg0: QueryRecordOptions) => Promise<HistoryResponse | null>;
/**
 ...
 */
export function retryAfterTimeout(
  retryCounter: number,
  request: Function
): Promise<any>;
